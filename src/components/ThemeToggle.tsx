...
import { LocalContext, LocalContextType } from '@/contexts/local'
...
const ThemeToggle: React.FC = () => {
  const { theme, handleChangeTheme } = useContext(
    LocalContext
  ) as LocalContextType
  ...
  return (
    <button
      ...
      aria-label="button"
    >
      {theme === Theme.DARK ? <SunIcon /> : null}
      {theme === Theme.LIGHT ? <MoonIcon /> : null}
    </button>
  )
}
